...
type MainWindow() =
    ...
    do
        base.Title <- "ImgurSlideshow Avalonia.FuncUI Elmish"
        ()
...
module Program =
    ...
    let appMain (app: Application) (args: string[]) =
        ...
        Elmish.Program.mkSimple (fun () -> ImgurSlideshowView.initialState) ImgurSlideshowView.update ImgurSlideshowView.view
